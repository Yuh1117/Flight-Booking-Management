...
from app.blueprints.bookings.dao import get_airports, get_routes
from app.blueprints.bookings.models import Reservation

@main_bp.route("/")
def home():
    dataAirport = get_airports()
    dataRoutes = get_routes()
    return render_template("main/home.html", dataAirport=dataAirport, dataRoutes = dataRoutes)
...
def manage_bookings():
    ...
    return render_template('managebookings/manage_bookings.html', reservations=reservations)